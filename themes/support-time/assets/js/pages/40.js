...
const haveAQuestionsForm = document.querySelector(".page-40.have-a-questions");
if (haveAQuestionsForm) {
    const formContent = haveAQuestionsForm.querySelector(".page-40.have-a-questions .content");
    const afterSendContent = haveAQuestionsForm.querySelector(".page-40.have-a-questions  .after-send");
    const btnSubmit = haveAQuestionsForm.querySelector(".page-40.have-a-questions .btn-send");
