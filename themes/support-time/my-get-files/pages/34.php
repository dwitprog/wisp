    ...
    <div class="container">
                ...
                <div class="bottom-wrapper">
                        ...
                        <div class="custom-select_list">
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="currentStatus[]"
                                       value="the first experience of cooperation" id="p34_currentStatus_1">
                                <label for="p34_currentStatus_1">
                                    <span>
                                    </span>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="currentStatus[]"
                                       ...
                                       id="p34_currentStatus_2">
                                <label for="p34_currentStatus_2">
                                    <span>
                                    </span>
                        ...
                        <div class="custom-select_list">
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="servicesPrice[]" value="not defined"
                                       id="p34_services_price_1">
                                <label for="p34_services_price_1">
                                    <span>
                                    </span>
                                    not defined
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="servicesPrice[]" value="5 000 $"
                                       id="p34_services_price_2">
                                <label for="p34_services_price_2">
                                    <span>
                                    </span>
                                    5 000 $
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="servicesPrice[]" value="10 000 $"
                                       id="p34_services_price_3">
                                <label for="p34_services_price_3">
                                    <span>
                                    </span>
                                    10 000 $
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="servicesPrice[]" value="15 000 $"
                                       id="p34_services_price_4">
                                <label for="p34_services_price_4">
                                    <span>
                                    </span>
                                    15 000 $
                                </label>
                    ...
                    <div class="btn-and-social">
                        ...
                        <div class="social-list">
                                                                <?php get_template_part('template-parts/form-social-icons', null, ['variant' => 'form', 'uid' => 'p34-form']); ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="after-send">
            <div class="after-send-content">
                ...
                <div class="social-list">
                                                <?php get_template_part('template-parts/form-social-icons', null, ['variant' => 'success', 'uid' => 'p34-success']); ?>
                </div>
            </div>
        </div>
    </div>
