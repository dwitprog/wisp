<section class="page-36 banner" data-header-theme="gradient1">
    <div class="service-menu">
        <div class="service-menu-list">
            ...
            <a href="/services/audit-service/" class="active">AUDIT</a>
...
<section class="page-36 project-stages" data-header-theme="white">
...
<section class="page-36 have-a-questions" data-header-theme="gradient1">
    <div class="container">
        <div class="content">
                ...
                <div class="bottom-wrapper">
                    <div class="select-services custom-select">
                        ...
                        <div class="custom-select_top">
                            <p class="custom-select_title">Scope of work</p>
                            <img
                        ...
                        <div class="custom-select_list">
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="scope[]" value="only data" id="p36_scope_1">
                                <label for="p36_scope_1">
                                    <span>
                                    </span>
                                    only data
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="scope[]" value="only tracking" id="p36_scope_2">
                                <label for="p36_scope_2">
                                    <span>
                                    </span>
                                    only tracking
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="scope[]" value="full analytics stack"
                                       id="p36_scope_3">
                                <label for="p36_scope_3">
                                    <span>
                                    </span>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="scope[]" value="other" id="p36_scope_4">
                                <label for="p36_scope_4">
                                    <span>
                                    </span>
                                    other
                                </label>
                    ...
                    <div class="select-services-price custom-select">
                        <span class="required">*</span>
                        <div class="custom-select_top">
                            <p class="custom-select_title">Execution timeline</p>
                            <img
                                src="/wp-content/themes/support-time/assets/img/repeat-elements/form/custom-checkbox-arrow-1.svg"
                                class="arrow arrow_default active" alt="arrow">
                            <img
                        ...
                        <div class="custom-select_list">
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="execution-speed[]" value="ASAP" id="p36_exec_1">
                                <label for="p36_exec_1">
                                    <span>
                                    </span>
                                    ASAP
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="execution-speed[]" value="within 1 month"
                                       id="p36_exec_2">
                                <label for="p36_exec_2">
                                    <span>
                                    </span>
                                    within 1 month
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="execution-speed[]" value="within 3 months"
                                       id="p36_exec_3">
                                <label for="p36_exec_3">
                                    <span>
                                    </span>
                                    within 3 months
                                </label>
                            ...
                            <div class="custom-select_item">
                                <input type="checkbox" class="onlyOne" name="execution-speed[]" value="flexible"
                                       id="p36_exec_4">
                                <label for="p36_exec_4">
                                    <span>
                                    </span>
                                    flexible
                                </label>
                    ...
                    <div class="btn-and-social">
                        ...
                        <div class="social-list">
                                                                <?php get_template_part('template-parts/form-social-icons', null, ['variant' => 'form', 'uid' => 'p36-form']); ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="after-send">
            <div class="after-send-content">
                ...
                <div class="social-list">
                                                <?php get_template_part('template-parts/form-social-icons', null, ['variant' => 'success', 'uid' => 'p36-success']); ?>
                </div>
            </div>
        </div>
    </div>
</section>
<section class="page-36 faq-accordion" data-header-theme="gradient2">
    <div class="container">
